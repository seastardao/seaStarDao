...
contract S7NFTPOOL is IERC721Receiver {
    enum opreate {
        stake,
        upStake,
        claim
    ...
    function _pledgeNft(address _sender, uint _tokenid) internal {
        ...
        IERC721(s7Nft).transferFrom(_sender, address(this), _tokenid);
    }
    ...
    function _unpack(address sender, uint _tokenid) private {
        ...
        IERC721(s7Nft).safeTransferFrom(address(this), sender, _tokenid);
