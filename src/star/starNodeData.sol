...
contract STARNODEDATA {
    ...
    mapping(address => WeightInfo) public globalWeightInfos;
    mapping(address => WeightInfo) public userWeightInfos;
    ...
    function setGlobalWeightInfo(
        address _user,
        WeightInfo memory _weightInfo
    ) external onlyStarNodeWork {
        globalWeightInfos[_user] = _weightInfo;
    }
    function setUserWeightInfo(
        address _user,
        WeightInfo memory _weightInfo
    ) external onlyStarNodeWork {
        userWeightInfos[_user] = _weightInfo;
    }
    ...
    function getGlobalWeightInfo(
        address _user
    ) external view returns (WeightInfo memory) {
        return globalWeightInfos[_user];
    }
    function getUserWeightInfo(
        address _user
    ) external view returns (WeightInfo memory) {
        return userWeightInfos[_user];
    }
